...
class CollectionCenterController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('cotton.center',compact('insurance','warehouse','user','operator','district'));
    }
...
public function discountModal(Request $request)
 ...
 public function stock_report(Request $request)
    ...
    public function cotton_movement_report(Request $request)
    {
        ...
        if($request->isMethod('post')){
            ...
            $data=PurchaseCotton::whereBetween('purchase_date',[$start_date,$end_date])->get();
        }
        }else{
            $data=[];
        }
        ...
        return view('cotton.cotton_movement_report',
            compact('start_date',
                'end_date','chart_of_accounts','data','account_id'));
    }
