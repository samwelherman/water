                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a
                                    ...
                                    data-toggle="tab">Token Tested Virtually List</a>
                            </li>
                            <li class="nav-item"><a class="nav-link @if(!empty($id)) active show @endif"
                                    href="#profile2" data-toggle="tab">Create New Virtual Testing Of Token</a></li>
                        </ul>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                ...
                                                {{ Form::open(['route' => 'tokenTest.store','role'=>'form','enctype'=>'multipart/form-data']) }}
                                                @method('POST')

                                                <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Token</label>
                                                    <div class="col-lg-8">
...
<script type="text/javascript">
    function model(id, type) {
        ...
        let url = '{{ route("tokenTest.show", ":id") }}';
