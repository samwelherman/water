                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a
                                    ...
                                    data-toggle="tab">Block Definition List</a>
                            </li>
                            <li class="nav-item"><a class="nav-link @if(!empty($id)) active show @endif"
                                    href="#profile2" data-toggle="tab">Create New Block Definition</a></li>
                        </ul>
                                        ...
                                        <tbody>
                                            ...
                                            @if(!@empty($blocks))
                                              @foreach ($blocks as $row)
                                                ...
                                                <div class = "input-group"> 
                                            <a href="{{ route('block.edit', $row->id)}}" class="btn btn-outline-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></a> 
                                        </div>&nbsp
                                  <div class = "input-group"> 
            {!! Form::open(['route' => ['block.destroy',$row->id], 'method' => 'delete']) !!}                                                   
            {{ Form::button('<i class="fa fa-trash"></i>', ['type' => 'submit', 'class' => 'btn btn-outline-danger  btn-xs ', 'title' => 'Delete', 'onclick' => "return confirm('Are you sure?')"]) }}
                   {{ Form::close() }}
                            ...
                            <div class="tab-pane fade @if(!empty($id)) active show @endif" id="profile2">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Create Block Definition</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                
                                                {{ Form::open(['route' => 'block.store','role'=>'form','enctype'=>'multipart/form-data']) }}
                                                @method('POST')

                                                <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Block 1 Definition</label>
                                                    <div class="col-lg-8">
                                                        <input type="text" name="block1" required
                                                            placeholder="Enter Block 1 Definition"
                                                            class="form-control">
                                                    </div>
                                                </div>

                                                <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Block 2 Definition</label>
                                                    <div class="col-lg-8">
                                                        <input type="text" name="block2" required
                                                            placeholder="Enter Block 2 Definition"
                                                            class="form-control">
                                                    </div>
                                                </div>

                                                <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Block 3 Definition</label>
                                                    <div class="col-lg-8">
                                                        <input type="text" name="block3" required
                                                            placeholder="Enter Block 3 Definition"
                                                            class="form-control">
                                                    </div>
                                                </div>

                                                <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Block 4 Definition</label>
                                                    <div class="col-lg-8">
                                                        <input type="text" name="block4" required
                                                            placeholder="Enter Block 4 Definition"
                                                            class="form-control">
                                                    </div>
                                                </div>
