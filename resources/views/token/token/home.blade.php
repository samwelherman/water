                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a
                                    ...
                                    data-toggle="tab">Token Generated List</a>
                            </li>
                            <li class="nav-item"><a class="nav-link @if(!empty($id)) active show @endif"
                                    href="#profile2" data-toggle="tab">Create New Token</a></li>
                        </ul>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                ...
                                                {{ Form::open(['route' => 'token.store','role'=>'form','enctype'=>'multipart/form-data']) }}
                                                @method('POST')
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input type="text" name="cardNo" required
                                                            placeholder="Enter Meter Card Number"
                                                            class="form-control">
                                                    </div>
                                                </div>
