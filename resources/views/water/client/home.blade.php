                                        ...
                                        <tbody>
                                            ...
                                            @if(!@empty($customers))
                                              @foreach ($customers as $row)
                                                ...
                                                <div class = "input-group"> 
                                            <a href="{{ route('customer.edit', $row->id)}}" class="btn btn-outline-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></a> 
                                        </div>&nbsp
                                  <div class = "input-group"> 
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <option value="">Select Client Location Name</option>
...
<script type="text/javascript">
    function model(id, type) {
        ...
        let url = '{{ route("customer.show", ":id") }}';
