                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a
                                    ...
                                    data-toggle="tab">Update Location</a>
                            </li>
                        </ul>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            {{ Form::model($water, array('route' => array('water.update', $water->id),'role'=>'form','enctype'=>'multipart/form-data' ,'method' => 'PUT')) }}
