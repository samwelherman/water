                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a
                                    ...
                                    data-toggle="tab">Update Unit Price Definition</a>
                            </li>
                        </ul>
                        <div class="tab-content tab-bordered">
                            ...
                            <div class="tab-pane fade @if(empty($id)) active show @endif" id="home2">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Edit Unit Price Definition</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                
                                            {{ Form::model($unit, array('route' => array('unit.update', $unit->id),'role'=>'form','enctype'=>'multipart/form-data' ,'method' => 'PUT')) }}
                                               
                                              <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Season Name</label>
                                                    <div class="col-lg-8">
                                                        <input type="text" name="season" required
                                                            value="{{  old('season', $unit->season) }}"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <option value="">{{  $unit->location }}</option>
