                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a
                                    ...
                                    data-toggle="tab">Daily Unit List</a>
                            </li>
                            <li class="nav-item"><a class="nav-link @if(!empty($id)) active show @endif"
                                    href="#profile2" data-toggle="tab">Create New Daily Unit</a></li>
                        </ul>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped " id="table-1">
                                        ...
                                        <tbody>
                                            ...
                                            @if(!@empty($dailys))
                                              @foreach ($dailys as $row)
                                                <tr class="gradeA even" role="row">
                                                  <th>{{ $loop->iteration }}</th>
                                                   <td>{{$row->meter}} &nbsp; (meters daily)</td>
                                                   <td><div class="form-inline">
                                                <div class = "input-group"> 
                                            <a href="{{ route('daily.edit', $row->id)}}" class="btn btn-outline-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></a> 
                                        </div>&nbsp
                                  <div class = "input-group"> 
            {!! Form::open(['route' => ['daily.destroy',$row->id], 'method' => 'delete']) !!}                                                   
            {{ Form::button('<i class="fa fa-trash"></i>', ['type' => 'submit', 'class' => 'btn btn-outline-danger  btn-xs ', 'title' => 'Delete', 'onclick' => "return confirm('Are you sure?')"]) }}
                   {{ Form::close() }}
                            ...
                            <div class="tab-pane fade @if(!empty($id)) active show @endif" id="profile2">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Create Daily Unit</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                
                                                {{ Form::open(['route' => 'daily.store','role'=>'form','enctype'=>'multipart/form-data']) }}
                                                @method('POST')
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input type="numberic" name="meter" required
                                                            placeholder="Enter Daily Meter Unit"
                                                            class="form-control">
                                                    </div>
                                                </div>
