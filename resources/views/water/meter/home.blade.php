                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a
                                    ...
                                    data-toggle="tab">Meter List</a>
                            </li>
                            <li class="nav-item"><a class="nav-link @if(!empty($id)) active show @endif"
                                    href="#profile2" data-toggle="tab">Create New Meter</a></li>
                        </ul>
                                        ...
                                        <tbody>
                                            ...
                                            @if(!@empty($meters))
                                              @foreach ($meters as $row)
                                                ...
                                                <div class = "input-group"> 
                                            <a href="{{ route('meter.edit', $row->id)}}" class="btn btn-outline-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></a> 
                                        </div>&nbsp
                                  <div class = "input-group"> 
            {!! Form::open(['route' => ['meter.destroy',$row->id], 'method' => 'delete']) !!}                                                   
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                ...
                                                {{ Form::open(['route' => 'meter.store','role'=>'form','enctype'=>'multipart/form-data']) }}
                                                @method('POST')

                                                <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Meter Name</label>
                                                    <div class="col-lg-8">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Meter Registration Number</label>
                                                    <div class="col-lg-8">
                                                        <input type="text" name="regNo" required
                                                            placeholder="Enter Meter Registration Number"
                                                            class="form-control">
                                                    </div>
                                                </div>
