                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a
                                    ...
                                    data-toggle="tab">Update Meter</a>
                            </li>
                        </ul>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            {{ Form::model($meter, array('route' => array('meter.update', $meter->id),'role'=>'form','enctype'=>'multipart/form-data' ,'method' => 'PUT')) }}
                                              ...
                                              <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <option value="">{{  $meter->location }}</option>
