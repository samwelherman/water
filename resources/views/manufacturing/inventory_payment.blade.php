            ...
            <div class="col-12 col-sm-6 col-lg-4">
                <div class="card row">
                    <div class="card-header">
                        <h4>Purchases Inventory Amount</h4>
                    </div>
                    <div class="card-body">
                        <table class="table">
                            <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('purchase_inventory.show',$invoice->id)}}">{{ $invoice->reference_no}}
                                            </a></td>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 ">
                                @if(isset($id))
                                {{ Form::model($id, array('route' => array('inventory_payment.update', $id), 'method' => 'PUT')) }}
                                @else
                                {{ Form::open(['route' => 'inventory_payment.store']) }}
                                @method('POST')
                                @endif
