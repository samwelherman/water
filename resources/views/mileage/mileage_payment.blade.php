                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 ">
                                ...
                                @else
                                {{ Form::open(['route' => 'mileage_payment.store']) }}
                                @method('POST')
                                @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="number" name="amount"
                                            value="{{ $invoice->due_mileage}}" class="form-control">

                                            <input type="hidden" name="mileage_id"
