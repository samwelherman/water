                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if(!empty($id)) active show @endif" id="profile-tab2"
                                    ...
                                    aria-selected="false">New Cards</a>
                            </li>
                                       ...
                                       <thead>
                                            <tr>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    style="width: 186.484px;">Card No</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                                    style="width: 186.484px;">Status</th>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>@if($row->status == 1)
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
<a class="btn btn-icon btn-info" title="Edit" onclick="return confirm('Are you sure?')"   href="{{ route("manage_cards.edit", $row->id)}}"><i class="fa fa-edit"></i></a>
                                                        </div>
                                            ...
                                            <div class="col-sm-12 ">
                                                ...
                                                @endif
                                                   ...
                                                   <div class="form-group row"><label
                                                        class="col-lg-2 col-form-label">Number Of Cards To be Generated <span class="required" style="color:red;"> * </span></label>
                                                    <div class="col-lg-8">
