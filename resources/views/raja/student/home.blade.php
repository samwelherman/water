                                        ...
                                        <tbody>
                                            ...
                                            @if(!@empty($students))
                                              @foreach ($students as $row)
                                                ...
                                                <div class = "input-group"> 
                                            <a href="{{ route('student.edit', $row->id)}}" class="btn btn-outline-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></a> 
                                        </div>&nbsp
                                  <div class = "input-group"> 
            {!! Form::open(['route' => ['student.destroy',$row->id], 'method' => 'delete']) !!}                                                   
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="">
                                                                    ...
                                                                    <input type="text" required name="fname" class="form-control" required placeholder="Enter First Name">
                                                                </div>

                                                                <div class="">
                                                                    <label class="control-label">Middle Name<span class="required">
                                                                            </span></label> </label>
                                                                    <input type="text" required name="mname" class="form-control" required placeholder="Enter Middle Name">
                                                                </div>

                                                                <div class="">
                                                                    <label class="control-label">Last Name<span class="required">
                                                                            </span></label> </label>
                                                                    <input type="text" required name="lname" class="form-control" required placeholder="Enter Last Name">
                                                                </div>
                                                                    <br>
                                                                 <div class="">   
                                                                <div class="form-group row">
                                                                        <label class="control-label"> Level Of School   <span class="required"></span></label>  
                                                                <div class="col-lg-9">                               
                                                                ...
                                                                <option value="">Select Class or Standard or Form Level</option>
