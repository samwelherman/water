                                        ...
                                        <tbody>
                                            ...
                                            @if(!@empty($schools))
                                              @foreach ($schools as $row)
                                                ...
                                                <div class = "input-group"> 
                                            <a href="{{ route('school.edit', $row->id)}}" class="btn btn-outline-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></a> 
                                        </div>&nbsp
                                  <div class = "input-group"> 
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="form-group row">
                                                                        <label class="control-label"> School Level/ Name   <span class="required"> *</span></label>  
                                                                <div class="col-lg-9">                               
                                                                ...
                                                                <div class="">
                                                                    <label class="control-label">School Fee Type
                                                                    </label>
                                                                    <input type="text" 
                                                                        name="feeType[]" value="" placeholder="Enter School Fee Type" 
                                                                        class="form-control">
                                                                </div>
                                                                <div class="">
                                                                    <label class="control-label">School Fee Price
                                                                    </label>
                                                                    <input type="text" data-parsley-type="number"
                                                                        name="price[]" value="" placeholder="Enter School Fee Price" 
                                                                        class="form-control">
                                                                </div>
                                                                <br>
