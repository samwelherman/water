                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('payments.show', $row->id)}}">{{ $row->supplier->name}}
                                            </a></td>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 ">
                                @if(isset($id))
                                {{ Form::model($id, array('route' => array('payments.update', $id), 'method' => 'PUT')) }}
                                @else
                                ...
                                <div class="form-group row"><label class="col-lg-2 col-form-label">Payment Date</label>
                                    ...
                                    <div class="col-lg-10">
                                        <input type="date" name="date" value="{{ isset($data) ? $data->date : date('d/m/y')}}" {{Auth::user()->can('edit-date') ? '' : 'readonly'}}
