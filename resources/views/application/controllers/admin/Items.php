...
class Items extends Admin_Controller
{
    ...
    public function itemsList($group_id = null)
    {
        if ($this->input->is_ajax_request()) {
            ...
            $this->datatables->join_where = array('tbl_customer_group.customer_group_id=tbl_saved_items.customer_group_id');

            $custom_field = custom_form_table_search(18);
            $action_array = array('saved_items_id');
            $main_column = array('item_name', 'item_desc', 'hsn_code', 'quantity', 'unit_cost', 'unit_type', 'customer_group');
