...
class Cache
{
    ...
    static function resolve_url($url, $protocol, $host, $base_path, Dompdf $dompdf)
    {
        ...
        $full_url = null;
        $enable_remote = $dompdf->config_items()->getIsRemoteEnabled();
            ...
            if (!$enable_remote && $remote && !$data_uri) {
                ...
                if ($enable_remote && $remote || $data_uri) {
                    ...
                    if (isset(self::$_cache[$full_url])) {
                        ...
                        $tmp_dir = $dompdf->config_items()->getTempDir();
    ...
    {
        if (empty(self::$_cache) || self::$_dompdf->config_items()->getDebugKeepTemp()) {
            return;
        }

        foreach (self::$_cache as $file) {
            if (self::$_dompdf->config_items()->getDebugPng()) {
