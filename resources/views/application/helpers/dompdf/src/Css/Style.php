...
class Style
{
    ...
    public function __construct(Stylesheet $stylesheet, $origin = Stylesheet::ORIG_AUTHOR)
    {
        ...
        if (!isset(self::$_defaults)) {
            ...
            $d["empty_cells"] = "show";
            $d["float"] = "none";
            $d["font_family"] = $stylesheet->get_dompdf()->config_items()->getDefaultFont();
            $d["font_size"] = "medium";
            $d["font_style"] = "normal";
    ...
    function length_in_pt($length, $ref_size = null)
    {
        ...
        foreach ($length as $l) {
            ...
            if (($i = mb_strpos($l, "px")) !== false) {
                $dpi = $this->_stylesheet->get_dompdf()->config_items()->getDpi();
    ...
    function get_font_family()
    {
        ...
        $DEBUGCSS = $this->_stylesheet->get_dompdf()->config_items()->getDebugCss();
