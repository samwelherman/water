                                ...
                                <div style="padding:5px;">
                                    ...
                                    <div style="width: 70%;float: left;">
                                        <div style="width: 100%;padding: 11px 0;">
                                            ...
                                            <div
                                                    class="payment_details_border_semi"><?= display_date($payments_info->payment_date); ?></div>
                                            <div style="clear:both;"></div>
                                        </div>
                                        <?php if (config_item('amount_to_words') == 'Yes') { ?>
                                            <div style="width: 100%;padding: 11px 0;">
                                                ...
                                                <div
                                                        class="payment_details_border_semi"><?= number_to_word('', $payments_info->amount); ?></div>
                                                <div style="clear:both;"></div>
                                            </div>
                                        <?php } ?>
