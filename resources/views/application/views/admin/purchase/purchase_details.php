            ...
            <div class="col-lg-6 col-xs-12 ">
                <div class="pull-right pr-lg">
                    ...
                    ?>
                      ...
                      <?php $show_custom_fields = custom_form_label(19, $supplier_info->supplier_id);
                if (!empty($show_custom_fields)) {
                    foreach ($show_custom_fields as $c_label => $v_fields) {
                        if (!empty($v_fields)) {
                            ?>
        ...
        <div class="row mb-lg">
            ...
            <div class="col-lg-6 col-xs-6 ">
                ...
                <div class="pl-sm">
                    ...
                    <?php } ?>
                    <?php if (!empty($supplier_info->vat)) { ?>
                        <br><?= lang('vat_number') ?>: <?= $supplier_info->vat ?>
                    <?php } ?>
                </div>
            </div>
            ...
            <table class="table">
                ...
                foreach ($all_payment_info as $v_payments_info) {
                    if (is_numeric($v_payments_info->payment_method)) {
                        ...
                        $payment_methods->method_name = $v_payments_info->payment_method;
                    }
