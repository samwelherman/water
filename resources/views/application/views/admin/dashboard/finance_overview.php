...
?>
            ...
            <h3 class="panel-title">
                ...
                <div class="pull-right hidden-xs" style="margin-top: -8px;">
                    <form role="form" id="form"
                          action="<?php echo base_url(); ?>admin/dashboard/finance_overview"
                        ...
                        <div class="pull-right">
                            <button type="submit" style="font-size: 15px" id="finance_overview_btn"
                                    data-toggle="tooltip"
    ...
    <span
            class="h4 font-bold m-t block"><?= display_money($total_annual['total_income'], default_currency()); ?></span>
                <small
                        class="text-muted m-b block"><?= lang('total_annual') . ' ' . lang('income') ?></small>
            </div>
            <div class="col-sm-3 text-center">
    <span
            class="h4 font-bold m-t block"><?= display_money($total_annual['total_expense'], default_currency()); ?></span>
                <small
                        class="text-muted m-b block"><?= lang('total_annual') . ' ' . lang('expense') ?></small>
            </div>
            <div class="col-sm-3 text-center ">
    <span
            class="h4 font-bold m-t block"><?= display_money($total_annual['total_profit'], default_currency()); ?></span>
                <small
