...
<section class="panel panel-custom">
    <header class="panel-heading">
        <div class="panel-title">
            <?php echo !empty($filterBy) ? ' ' . lang('creditor_report') . ' -> ' . lang($filterBy) : lang('sales_report') ?>
            <div class="pull-right">
                <div class="btn-group ">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="<?= base_url() ?>admin/report/creditor_report/invoices"><?= lang('invoices_report') ?></a>
                        </li>
                        <li>
                            <a href="<?= base_url() ?>admin/report/creditor_report/invoice_by_client"><?= lang('invoice_by_client') ?></a>
                        </li>
                        <li>
                ...
                if (!empty($filterBy)) {
                    ...
                    <a data-toggle="tooltip" data-placement="top"
                       href="<?= base_url() ?>admin/report/creditor_report_pdf/<?= $filterBy . '/' . $status . '/' . implode('/', $range) ?>"
                       title="<?= lang('pdf') ?>"
                    ...
                    <div class="col-sm-3">
                        <section class="panel panel-info">
                            ...
                            <span class="text-dark"><?= lang('total_sales') ?></a>
                                <small class="block text-danger pull-right ">
                                    <?= display_money($this->invoice_model->all_baki(), $cur->symbol) ?>
                        ...
                        <section class="panel panel-info">
                            ...
                            <span class="text-dark"><?= lang('paid_this_year') ?></a>
                                <small class="block text-danger pull-right">
                                    <strong>
                                        <?= display_money($this->invoice_model->all_baki(date('Y')), $cur->symbol) ?>
                                    </strong>
                                </small>
                                </div>
                            </div>
                        ...
                        <section class="panel panel-info">
                            ...
                            <span class="text-dark"><?= lang('paid_this_month') ?></a>
                                <small class="block text-danger pull-right ">
                                    <strong>
                                        <?= display_money($this->invoice_model->all_baki(date('Y'), date('m')), $cur->symbol) ?>
                                    </strong>
                                </small>
                                </div>
                            </div>
                        ...
                        <section class="panel panel-info">
                            <div class="panel-body">
                                <div class="clear">
                            <span class="text-dark"><?= lang('number') . ' of  ' . lang('payments') ?></a>
                                <small
