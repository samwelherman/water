...
<section class="panel panel-custom">
    <header class="panel-heading">
        <div class="panel-title">
            <?php echo !empty($filterBy) ? ' ' . lang('purchase_report') . ' -> ' . lang($filterBy) : lang('purchase_report') ?>
            <div class="pull-right">
                <div class="btn-group ">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="<?= base_url() ?>admin/report/purchase_report/purchase"><?= lang('purchase_report') ?></a>
                        </li>
                        <li>
                            <a href="<?= base_url() ?>admin/report/purchase_report/purchase_by_supplier"><?= lang('purchase_by_supplier') ?></a>
                        </li>
                        <li>
                            <a href="<?= base_url() ?>admin/report/purchase_report/Supplier_payments"><?= lang('payments_report') ?></a>
                        </li>
    ...
    <div id="<?= $id ?>">
        ...
        <div class="panel-body table-responsive">
            <?php
            if (!empty($filterBy)) {
                if ($filterBy == 'purchase' || $filterBy == 'purchase_by_supplier') {
                    $this->load->view('admin/report/lpo');
                        ...
                        <section class="panel panel-info">
                            ...
                            <span class="text-dark"><?= lang('total_sales') ?></a>
                                <small class="block text-danger pull-right ">
                                    <?= display_money($this->purchase_model->total_sales(), $cur->symbol) ?>
