...
?>
    <div id="proposals_state_report_div"> <?php //$this->load->view("admin/proposals/proposals_state_report"); ?></div>
   <?php
...
<script>
    $(document).ready(function () {  ins_data(base_url+'admin/proposals/proposals_state_report')   });
</script>