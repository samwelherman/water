    ...
    <div class="row">
        <div class="col-md-3 hidden-print"><!-- ************ Expense Report Month Start ************-->
            <ul class="mt nav nav-pills nav-stacked navbar-custom-nav">
                <?php
                foreach ($wcf_info as $key => $v_wcf_info):
                    ...
                    ?>">
                        <div class="panel panel-custom">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                ?>
                                <?php if (!empty($v_wcf_info)): foreach ($v_wcf_info as $wcf_info) : ?>
                                    <tr>
                                <td><?php echo $wcf_info->employment_id ?></td>
                                        <td><?php echo $wcf_info->fullname ?></td>
                                        <td><?= strftime(config_item('date_format'), strtotime($wcf_info->paid_date)) ?></td>
                                      
                                     
                                      
                                      
                                      
                                        <td><?php echo display_money($wcf_info->salary_payment_deduction_value, $curency->symbol);
                                            $total_amount += $wcf_info->salary_payment_deduction_value;
                                            ?></td>
