    ...
    <div class="row">
        <div class="col-md-3 hidden-print"><!-- ************ Expense Report Month Start ************-->
            <ul class="mt nav nav-pills nav-stacked navbar-custom-nav">
                <?php
                foreach ($nhif_info as $key => $v_nhif_info):
                    ...
                    ?>">
                        <div class="panel panel-custom">
                            <div class="panel-heading">
                                <div class="panel-title">
                                    ...
                                    <div class="pull-right hidden-print">
                                            <span class="hidden-print"><?php echo btn_pdf('admin/payroll/nhif_info/' . $year . '/' . $key); ?></span>
                                    </div>
                                </div>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                ?>
                                <?php if (!empty($v_nhif_info)): foreach ($v_nhif_info as $nhif_info) : ?>
                                    <tr>
                                <td><?php echo $nhif_info->employment_id ?></td>
                                        <td><?php echo $nhif_info->fullname ?></td>
                                        <td><?= strftime(config_item('date_format'), strtotime($nhif_info->paid_date)) ?></td>
                                      
                                     
                                      
                                      
                                      
                                        <td><?php echo display_money($nhif_info->salary_payment_allowance_value /*$curency->symbol*/);
                                            $total_amount += $nhif_info->salary_payment_allowance_value;
                                            ?></td>
                                         

                                             <!---  <td><?php echo display_money($nhif_info->salary_payment_deduction_value, $curency->symbol);
                                            $total_amount += $nhif_info->salary_payment_deduction_value;
                                            ?></td>!-->
