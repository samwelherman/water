...
<div class="row">
    <div class="col-sm-3">
        <form id="existing_customer" action="<?php echo base_url() ?>admin/payroll/tax_fund" method="post">
    ...
    <div class="row">
        <div class="col-md-3 hidden-print"><!-- ************ Expense Report Month Start ************-->
            <ul class="mt nav nav-pills nav-stacked navbar-custom-nav">
                <?php
                foreach ($tax_fund as $key => $v_tax_fund_info):
                    ...
                    ?>">
                      <div class="panel panel-custom">
                            <div class="panel-heading">
                                <div class="panel-title">
                                    ...
                                    <div class="pull-right hidden-print">
                                            <span class="hidden-print"><?php echo btn_pdf('admin/payroll/tax_fund_pdf/' . $year . '/' . $key); ?></span>
                                    </div>
                                </div>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                ?>
                                <?php if (!empty($v_tax_fund_info)): foreach ($v_tax_fund_info as $tax_fund) : ?>
                                    <tr>
                                <td><?php echo $tax_fund->employment_id ?></td>
                                        <td><?php echo $tax_fund->fullname ?></td>
                                        
                                        <td><?= strftime(config_item('date_format'), strtotime($tax_fund->paid_date)) ?></td>
                                         
                                         <td><?php echo display_money($tax_fund->salary_payment_details_value, $curency->symbol);
                                           
                                            ?></td>   
                                              
                                               <td><?php echo display_money($tax_fund->salary_payment_deduction_value, $curency->symbol);
                                            $total_amount += ($tax_fund->salary_payment_deduction_value);
                                            ?></td>
                                              
                                           <td><?php echo display_money(($tax_fund->salary_payment_details_value)*0.045, $curency->symbol);
                                            $total_amount += ($tax_fund->salary_payment_details_value)*0.045;
                                            ?></td>    
                                ...
                                endforeach;
                                    ...
                                    <tr class="total_amount">
                                        <td colspan="3" style="text-align: right;">
                                            <strong><?= lang('total') . ' ' . lang('tax_deduction') ?>
                                                : </strong></td>
