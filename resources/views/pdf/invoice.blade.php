...
?>
    ...
    <div>
    <center> <a href="{{ route('pdfview',['download'=>'pdf','id'=>$pacel->id,'type'=>'invoice','invoice_id'=>$invoice->id]) }}">Download PDF</a> </center>
    </div>
      <div id="logo">
    ...
    <main>
      <div id="details" class="clearfix">
        ...
        <div id="invoice">
          <h3>INVOICE NO {{$invoice->serial_no}}</h3>
          <div class="date">Invoice Date: {{$invoice->created_at}}</div>
          
        </div>
      </div>
      <div>
       <p><center><h3>Invoice For  {{$client_Details->fname}}</h3></center></p>
       </div>
