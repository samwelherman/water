                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a
                                    ...
                                    data-toggle="tab">Communities List</a>
                            </li>
                            <li class="nav-item"><a class="nav-link @if(!empty($id)) active show @endif"
                                    href="#profile2" data-toggle="tab">Create New Community</a></li>
                        </ul>
                                        ...
                                        <tbody>
                                            ...
                                            @if(!@empty($communities))
                                              @foreach ($communities as $row)
                                                ...
                                                <div class = "input-group"> 
                                            <a href="{{ route('community.edit', $row->id)}}" class="btn btn-outline-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></a> 
                                        </div>&nbsp
                                  <div class = "input-group"> 
            {!! Form::open(['route' => ['community.destroy',$row->id], 'method' => 'delete']) !!}                                                   
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                ...
                                                {{ Form::open(['route' => 'community.store','role'=>'form','enctype'=>'multipart/form-data']) }}
                                                @method('POST')
                                            ...
                                            <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input type="text" name="chairman" required
                                                            placeholder="Enter Chairman Name of the Community"
                                                            class="form-control">
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input type="text" name="secretary" required
                                                            placeholder="Enter Secretary Name of the Community"
                                                            class="form-control">
                                                    </div>
                                            </div>  
                                            ...
                                            <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input type="text" name="location" required
                                                            placeholder="Enter Location of the Community"
                                                            class="form-control">
                                                    </div>
                                            </div>  
