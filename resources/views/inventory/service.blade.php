                            ...
                            <div class="tab-pane fade @if(!empty($id)) active show @endif" id="profile2" role="tabpanel"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <td>
                              <select name="item_name[]" class="form-control item_name" required><option value="">Select Item</option>@foreach($name as $n) <option  @if(isset($in))
...
$(document).ready(function() {
    ...
    $(document).on('click', '.addCF', function() {
        ...
        html +=
            ...
            count +
            '"><option value="">Select Item</option>@foreach($i_name as $i_n) <option value="{{ $i_n->id}}">{{$i_n->name}}</option>@endforeach</select></td>';
        html +=
