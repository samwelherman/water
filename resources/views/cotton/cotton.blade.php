                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link @if(empty($id)) active show @endif" id="home-tab2" data-toggle="tab"
                                    href="#home2" role="tab" aria-controls="home" aria-selected="true">Stock
                                    List</a>
                            </li>
                            @can('add-items')
                            <li class="nav-item">
                                <a class="nav-link @if(!empty($id)) active show @endif" id="profile-tab2"
                                    ...
                                    aria-selected="false">New Stock</a>
                            </li>
                            @endcan
                                                ...
                                                <td>
                                                  @can('edit-items')
                                                    <a class="btn btn-xs btn-outline-info text-uppercase px-2 rounded"
                                                        href="{{ route("cotton_list.edit", $row->id)}}">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    @endcan
                                                   
  @can('delete-items')
                                                    {!! Form::open(['route' => ['cotton_list.destroy',$row->id],
                                                    'method' => 'delete']) !!}
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                     @if(isset($id))
                                                {{ Form::model($id, array('route' => array('cotton_list.update', $id), 'method' => 'PUT')) }}
                                                @else
                                                {{ Form::open(['route' => 'cotton_list.store']) }}
                                                @method('POST')
                                                @endif
