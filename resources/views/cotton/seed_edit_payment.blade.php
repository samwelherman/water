                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('cotton_sales.show',$invoice->id)}}">{{ $invoice->reference}}
                                            </a></td>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 ">
                                @if(isset($id))
                                {{ Form::model($id, array('route' => array('seed_sales_payment.update', $id), 'method' => 'PUT')) }}
                                @else
                                {{ Form::open(['route' => 'seed_sales_payment.store']) }}
                                @method('POST')
                                @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="number" name="amount"
                                            ...
                                            value="{{ $data->invoice_id }}" class="form-control">
                                    </div>
                                </div>
