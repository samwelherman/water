                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link @if(empty($id)) active show @endif" id="home-tab2" data-toggle="tab"
                                    href="#home2" role="tab" aria-controls="home" aria-selected="true">Levy Report
                                    List</a>
                            </li>
...
<br>
@php
$center=App\Models\Cotton\Levy::where('account_id',$account_id)->first();
@endphp
            ...
            <div class="panel-body ">
                <div class="table-responsive">
                    ...
                    <th>Balance</th>
                        ...
                        $cr = \App\Models\JournalEntry::where('account_id', $account_id)->whereBetween('date',
                            [$start_date, $end_date])->sum('credit');
                        $dr = \App\Models\JournalEntry::where('account_id', $account_id)->whereBetween('date',
                            [$start_date, $end_date])->sum('debit');
                        $collection=\App\Models\Cotton\CollectionCenter::where('id',$key->center_id)->first();
                        ?>
                            <tr>
                    ...
                    <td>{{ number_format($key->credit - $key->debit,2) }}</td>                                
                             <td>{{ $key->notes }}</td>
                        ...
                        <tfoot>
                            <tr class="custom-color-with-td">
                                ...
                                <td><b>{{ number_format($cr,2) }}</b></td>
                                    ...
                                    <td><b>{{ number_format($cr-$dr,2) }}</b></td>
                            </tr>
                        </tfoot>
                    </table>
