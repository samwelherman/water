...
<table class="items">
    ...
    <tbody>
            ...
            <tr>
                ...
                <td class="unit" style="text-align: right">{{ $purchases->quantity }}</td>
                <td class="unit" style="text-align: right">{{number_format($purchases->price ,2)}}</td>
...
@endif
                ...
                <td class="unit" style="text-align: right">{{number_format($purchases->due_amount ,2)}}</td>
