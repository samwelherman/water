                                            ...
                                            <div class="badge badge-success badge-shadow">Approved</span>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
<a class="btn btn-icon btn-info" title="Edit" onclick="return confirm('Are you sure?')"   href="{{ route("assign_driver.edit", $row->id)}}"><i class="fa fa-edit"></i></a>
                                                        </div>
                                                     
                                                        <div class="col-lg-4">
                                                            {!! Form::open(['route' => ['assign_driver.destroy',$row->id], 'method' => 'delete']) !!}
...
<br>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu animated zoomIn">
                                                            <a  class="nav-link" title="Confirm Payment" onclick="return confirm('Are you sure? you want to confirm')"  href="{{ route('assign_driver.approve', $row->id)}}">Confirm Assignment</a></li>
                                                                          </ul></div>
                                                
                                                 
                                                    @endif

                                      @if($row->status == 1 && $row->reversed == 0)
...
<br>
                              <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu animated zoomIn">
 @if($row->reversed == 0)
                   <li class="nav-item"><a  class="nav-link" title="Edit" data-toggle="modal" class="discount"  href="" onclick="model({{ $row->id }},'driver')" value="{{ $row->id}}" data-target="#appFormModal" >Reverse</a></li>
@endif
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($id))
                                                {{ Form::model($id, array('route' => array('assign_driver.update', $id), 'method' => 'PUT')) }}
                                                @else
                                                {{ Form::open(['route' => 'assign_driver.store']) }}
                                                @method('POST')
                                                @endif
                                                   <div class="form-group row">
                                                    ...
                                                    <option value="">Select Truck</option> 
                                                          @foreach ($driver as $drive)                                                             
                                                            <option value="{{$drive->id}}" @if(isset($data))@if($data->driver_id == $drive->id) selected @endif @endif >{{$drive->reg_no}}</option>
                                                               @endforeach
                                                              </select>
                                                    </div>
                                                </div>
