            ...
            <td><input type="text" id="max" name="max"   class="form-control "></td>
                                            ...
                                            <div class="col-sm-12 ">
                                                ...
                                                @endif
                                                   <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                       <select class="operator" name="from_account_id" id="user_id" required>
                     ...
                     @if(!empty($data))
                      <label
                                                    ...
                                                    <div class="col-lg-8">
                                                       <select class="m-b" name="to_account_id" id="account_id"  required>
                 ...
                 @else
                                 <label
                                                        class="col-lg-2 col-form-label">Collection Center</label>
                                                    <div class="col-lg-8">
                                                       <select class="colection_center2 m-b" name="to_account_id" id="account_id"  required>
                                                    <option value="">Select Collection Center</option> 
