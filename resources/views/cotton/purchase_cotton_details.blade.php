        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
               ...
               <div class="col-lg-10">
                 ...
                 <a class="btn btn-xs btn-primary"  onclick="return confirm('Are you sure?')"   href="{{ route('purchase_cotton.edit', $purchases->id)}}"  title="" > Edit </a>          
            
                           
              <a class="btn btn-xs btn-info" data-placement="top"  href="{{ route('cotton.receive',$purchases->id)}}"  title="Good Receive"> Good Receive </a>   
           @endif  
             
             <a class="btn btn-xs btn-success"  href="{{ route('cotton_pdfview',['download'=>'pdf','id'=>$purchases->id]) }}"  title="" > Download PDF </a>         
                        ...
                        <th class="col-sm-1" style="color:white;">Total</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <td class="">{{ $purchases->quantity }} </td>
                                        <td class="">{{number_format($purchases->price ,2)}}  </td>                                         
                                         <td class="">
                                  @if(!@empty($purchases->purchase_tax > 0))
                              <small class="pr-sm">VAT ({{ $purchases->tax_rate * 100 }} %)</small> {{number_format($purchases->purchase_tax ,2)}} 
@endif
</td>
                                            <td class="">{{number_format($purchases->due_amount ,2)}} </td>
 ...
 <div class="clearfix">
  ...
  @if(!@empty($purchases->due_amount < $purchases->purchase_amount ))
        <div class="clearfix">
