                                            ...
                                            <div class="badge badge-success badge-shadow">Approved</span>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
<a class="btn btn-icon btn-info" title="Edit" onclick="return confirm('Are you sure?')"   href="{{ route("assign_center.edit", $row->id)}}"><i class="fa fa-edit"></i></a>
                                                        </div>
                                                     
                                                        <div class="col-lg-4">
                                                            {!! Form::open(['route' => ['assign_center.destroy',$row->id], 'method' => 'delete']) !!}
...
<br>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu animated zoomIn">
                                                            <a  class="nav-link" title="Confirm Payment" onclick="return confirm('Are you sure? you want to confirm')"  href="{{ route('assign_center.approve', $row->id)}}">Confirm Assignment</a></li>
                                                                          </ul></div>
...
<br>
                              <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu animated zoomIn">
 @if($row->reversed == 0)
                   <li class="nav-item"><a  class="nav-link" title="Edit" data-toggle="modal" class="discount"  href="" onclick="model({{ $row->id }},'assign')" value="{{ $row->id}}" data-target="#appFormModal" >Reverse</a></li>
@endif
